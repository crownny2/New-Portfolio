...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "Daily Fade",
    description:
      "A full-stack barbershop booking web application for online appointment scheduling, barber availability management, and secure payment processing, with a seamless booking experience optimized for both desktop and mobile.",
    image: "/projects/DailyFade.png",
    stack: ["Laravel", "Next.js", "TypeScript", "Tailwind CSS", "PostgreSQL"],
    year: "2026",
    github: "https://github.com/crownny2/daily-fade.git",
    live: "https://daily-fade-ten.vercel.app/",
    featured: true,
    problem:
      "The barbershop relied on manual appointment scheduling, making it difficult to manage barber availability, prevent double bookings, track appointments, and provide customers with a convenient way to schedule their preferred services.",
    solution:
      "Developed a complete online booking platform that allows customers to browse services, select a barber, choose an available date and time slot, and manage their appointments. The system also provides dedicated admin and barber functionality for managing schedules, services, customers, appointments, payments, and business operations.",
    features: [
      "Customer registration, login, and profile management",
      "Online appointment booking and scheduling",
      "Service and barber selection",
      "Real-time barber availability and time-slot validation",
      "Double-booking prevention",
      "Appointment confirmation and cancellation",
      "Admin dashboard with appointment and customer insights",
      "Service management and CRUD operations",
      "Barber profile and schedule management",
      "Customer management",
      "Payment support for Cash, GCash, and Maya",
      "Payment status and transaction management",
      "Role-based access control for Admin, Barber, and Customer",
      "Appointment notifications",
      "Reports and business management features",
      "RESTful API architecture with secure backend validation and authorization",
      "Responsive UI optimized for desktop and mobile",
    ],
    lessons:
      "Building Daily Fade strengthened my understanding of full-stack application development, particularly in designing real-world booking workflows, implementing role-based access control, preventing scheduling conflicts, managing relational data, and connecting frontend interfaces with backend APIs. The project also taught me how to handle real-world edge cases such as unavailable time slots, appointment cancellations, payment states, and authorization across different user roles while maintaining a clean and responsive user experience.",
  },
  {
    slug: "pzam-cups",
