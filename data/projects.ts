...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "Daily Fade",
    description:
      "A full-stack barbershop booking and management platform with real-time scheduling, separate customer, admin, and barber-facing portals, and a custom dark, gold-accented admin SaaS interface.",
    image: "/projects/DailyFade.png",
    stack: ["Laravel", "React", "TypeScript", "Supabase", "Vercel", "Render"],
    year: "2026",
    // TODO: add your repo link here, e.g. "https://github.com/crownny2/daily-fade"
    // github: "",
    // TODO: add your live deployment link here once seeding/verification is done
    // live: "",
    featured: true,
    problem:
      "Barbershops typically rely on manual, message-based booking, making it hard to prevent double bookings, manage barber schedules, and give customers a clear view of availability.",
    solution:
      "Built a full-stack booking platform with a real-time slot calculation engine and double-booking prevention, plus dedicated portals for customers, admins, and barbers, all backed by a Laravel API and Supabase database.",
    features: [
      "Real-time slot calculation with double-booking prevention",
      "Separate customer, admin, and barber-facing portals",
      "Full admin suite: appointments, services, barbers, customers, payments, schedules, notifications, and reports",
      "Custom design token system for a consistent dark, gold-accented admin SaaS interface",
      "RESTful APIs built with Laravel powering a responsive React/TypeScript frontend",
      "Deployed with frontend on Vercel, backend on Render (Docker), and Supabase for the database",
    ],
    lessons:
      "My first full production deployment end-to-end — working through PHP extension gaps, PHP version mismatches, and IPv6 incompatibility on Render's free tier taught me a lot about the gap between 'runs on my machine' and a real, live deployment.",
  },
  {
    slug: "pzam-cups",
